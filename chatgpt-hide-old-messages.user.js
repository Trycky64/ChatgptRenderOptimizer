...
// @namespace    https://github.com/trycky64/chatgpt-hide-old-messages
// @version      1.0
...
(function() {
    ...
    function updateVisibility() {
      ...
      if (total > visibleCount) {
        messages.slice(0, total - visibleCount).forEach(el => el.style.display = 'none');
        messages.slice(total - visibleCount).forEach(el => el.style.display = '');
      } else {
